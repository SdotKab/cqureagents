      ...
      <table className="w-full text-[10px] md:text-sm text-left table-auto">
        <thead>
          <tr className="text-gray-600 border-b border-slate-200">
            <th className="py-1 px-1 w-1/3">Critical</th>
            <th className="py-1 px-1 w-1/3">High</th>
            <th className="py-1 px-1 w-1/3">Moderate</th>
          </tr>
        </thead>
        <tbody>
...
export default ClientRisksCard